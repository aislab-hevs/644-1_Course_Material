package ch.hevs.aislab.introfirebase.ui;
...
import ch.hevs.aislab.introfirebase.R;
import ch.hevs.aislab.introfirebase.adapter.RecyclerAdapter;
import ch.hevs.aislab.introfirebase.database.entity.ClientEntity;
import ch.hevs.aislab.introfirebase.util.RecyclerViewItemClickListener;
import ch.hevs.aislab.introfirebase.viewmodel.ClientListViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel = new ViewModelProvider(this, factory).get(ClientListViewModel.class);
